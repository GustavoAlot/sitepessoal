...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Site para calcular a média de produção de energia solar baseado na sua localização.',
    longDescription: `
    ...
    {
    title: 'Meu GitHub',
    description: 'Sinta-se à vontade para explorar outros projetos e códigos no meu GitHub! Lá você vai encontrar desde trabalhos acadêmicos e estudos experimentais até projetos em desenvolvimento e algumas informações extras sobre mim.',
